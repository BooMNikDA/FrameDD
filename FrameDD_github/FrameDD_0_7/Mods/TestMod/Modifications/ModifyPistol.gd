...
@export var node_path: NodePath = NodePath("CameraRoot/Camera3D/WeaponManager/Weapons/Makarov/Graphics/Bones/Skeleton3D/Cube/Cube")

@export var new_model_path: String = "res://Models/shotgun.glb"
...
@export var custom_rotation: Vector3 = Vector3(0, 180, 0)
